...
<nav aria-label="Page navigation">
  <ul class="pagination mt-4 justify-content-center">
    ...
    <li class="page-item"><a class="page-link" onclick="go_page(${page.beginPage - page.blockPage})"><i class="fa-solid fa-angle-left"></i></a></li>
    </c:if>
    ...
    <c:if test="${page.curBlock lt page.totalBlock}"> <!-- 마지막블럭이 아닌 경우 보이게 -->

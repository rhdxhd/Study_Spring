...
<tr><th>첨부파일</th>
	<td><div class="row">
   			 ...
   			 <label>
       			 ...
       			 <i role="button" class="ms-2 fa-solid fa-paperclip fs-3"></i>
       			 
   			 </label>
   			 <div class="ms-4 d-flex align-items-center">
   			 	<span class="file-name">${vo.filename} </span>
   			 	<i role="button" class="ms-4 file-delete ${empty vo.filename ? 'd-none' : ''} text-danger fs-4 fa-regular fa-trash-can"></i>
   			 </div>
   		 </div>
	  </div>
	</td>
